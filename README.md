...
Java / Spring Boot 기반 백엔드 개발자를 목표로 하며,  
데이터 정합성과 서비스 안정성을 고민하는 개발자가 되고 싶습니다.
...
- Java와 Spring Boot 기반의 백엔드 개발을 중심으로 학습하고 있습니다.
- 주문, 결제, 재고, 알림처럼 서비스의 핵심 흐름을 API와 데이터 구조로 설계하는 데 관심이 있습니다.
- Redis Lua Script 기반 재고 선점, RabbitMQ 기반 비동기 알림, k6 부하 테스트를 경험했습니다.
- 문제를 감으로 판단하기보다 직접 재현하고 측정한 뒤 개선하는 개발자가 되고 싶습니다.
